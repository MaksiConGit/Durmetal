...
return new class extends Migration
{
    ...
    {
        Schema::create('item_nota_credito_compra', function (Blueprint $table) {
            $table->id();
            $table->foreignId('IdNotaCreditoCompra')->nullable()->constrained('nota_credito_compra')
                                                                ->onDelete('restrict')
                                                                ->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('item_nota_credito_compra');
    }
};
