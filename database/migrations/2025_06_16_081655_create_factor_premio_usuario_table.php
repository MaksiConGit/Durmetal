...
return new class extends Migration
{
    ...
    {
        Schema::create('factor_premio_usuario', function (Blueprint $table) {
            $table->id();
            $table->foreignId('IdUsuario')->nullable()->constrained('users')
                                                        ->onDelete('restrict')
                                                        ->onUpdate('cascade');
            $table->foreignId('IdFactorPremio')->nullable()->constrained('factor_premio')
                                                            ->onDelete('restrict')
                                                            ->onUpdate('cascade');
            $table->float('Valor');
    ...
    {
        Schema::dropIfExists('factor_premio_usuario');
    }
};
