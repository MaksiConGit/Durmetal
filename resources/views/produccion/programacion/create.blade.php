        ...
        <div class="row">
            <div class="col-3">
                <div class="form-group mb-0">
                    <select name="IdTipoProgramacion" id="" class="form-control form-control-sm">
        ...
        <div class="row mt-3">
            ...
            <div class="col-3">
                <div class="form-group mb-0">
                    ...
                    <input type="text" id="filtro4" name="Temperatura" class="form-control form-control-sm" value="{{ old('Temperatura', 0) }}">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group mb-0">
