...
<div class="seccion">
    CLIENTE:
    {{ $certificado->itemOrdenTrabajo->ordenTrabajo->cliente->Nombre }}
</div>
...
<table class="tabla-100">
    <tr>
        <td width="50%">
            Cantidad:
            {{ number_format($certificado->Cantidad, 2) }}
        </td>
...
<table class="tabla-100" style="margin-top:10px;">
    <tr>
        ...
        <td width="60%" valign="top">
            ...
            Mínimo:
            {{ number_format($certificado->itemOrdenTrabajo->DurezaSolicitadaMinima, 2) }}
            <br>

            Máximo:
            {{ number_format($certificado->itemOrdenTrabajo->DurezaSolicitadaMaxima, 2) }}
            <br>

            Dureza Tipo:
            {{ $certificado->itemOrdenTrabajo->Dureza->Nombre }}
