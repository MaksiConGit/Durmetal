<x-layout>
  ...
  <x-slot name="breadcrumbs">
      <li class="nav-home">
        ...
        <li class="separator"><i class="icon-arrow-right"></i></li>
        <li class="nav-item"><a href="#">Editar factor premio</a></li>
  </x-slot>

    <x-form>
        <x-slot name="card_title">Editar factor premio</x-slot>
        <x-slot name="action">{{ route('factores-premio.update', $factor_premio) }}</x-slot>
        ...
        <x-slot name="inputs">
            ...
            <div class="col-md-6 mb-3">
                <x-form-input-default>
                    ...
                    <x-slot name="value">{{old('Nombre', $factor_premio->Nombre)}}</x-slot>
                    <x-slot name="message">
                ...
                <x-form-input-checkbox>
                    ...
                    <x-slot name="checked">
                        {{ old('Activo', $factor_premio->Activo) == 1 ? 'checked' : '' }}
                    </x-slot>
                </x-form-input-checkbox>
            </div>
            ...
            <div class="col-md-6 mb-3">
                <x-form-input-default>
                    ...
                    <x-slot name="placeholder"></x-slot>
                    <x-slot name="value">{{ number_format(old('ValorPredeterminado', $factor_premio->ValorPredeterminado), 2, '.', '') }}</x-slot>
                    <x-slot name="message">
