        ...
        <x-slot name="inputs">
            ...
            <div class="col-md-2 mb-3">
                <x-form-input-default>
                    ...
                    <x-slot name="value">{{old('CC', $next_codigo)}}</x-slot>
                    <x-slot name="message">
                        @if ($errors->has('CC'))
                            {{ $errors->first('CC') }}
                        @elseif (old('CC'))
            ...
            <div class="col-md-2 mb-3">
                <x-form-input-default>
                    ...
                    <x-slot name="value">{{old('Precio')}}</x-slot>
                    <x-slot name="message">
            ...
            <div class="col-md-3 mb-3">
                <x-form-input-default>
                    ...
                    <x-slot name="placeholder">0.00</x-slot>
                    <x-slot name="value">{{old('PorcentajeCoeficiente')}}</x-slot>
                    <x-slot name="message">
            ...
            <div class="col-md-3 mb-3">
                <x-form-input-default>
                    ...
                    <x-slot name="value">{{old('Coeficiente')}}</x-slot>
                    <x-slot name="message">
