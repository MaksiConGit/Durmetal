<x-layout>
    ...
    <x-form>
        ...
        <x-slot name="action">{{ route('repartir-premios.update', $premio) }}</x-slot>
        ...
        <div class="row mb-3 align-items-center">
            ...
            <div class="col-md-3">
                ...
                <x-form-input-default>
                    ...
                    <x-slot name="value">{{old('Nombre', $premio->Nombre)}}</x-slot>
                    <x-slot name="message">
            ...
            <div class="col-md-3">
                ...
                <x-form-input-date>
                    ...
                    <x-slot name="value">
                        {{ old('FechaDesde', $premio->FechaDesde) }}
                    </x-slot>               
                    <x-slot name="message">
            ...
            <div class="col-md-3">
                ...
                <x-form-input-date>
                    ...
                    <x-slot name="value">
                        {{ old('FechaHasta', $premio->FechaHasta) }}
                    </x-slot>
                    <x-slot name="message">
            ...
            <div class="col-md-3">
                <x-form-input-select>
                    ...
                    <x-slot name="option">
                        <option value="PENDIENTE" {{"PENDIENTE" == old('Estado') ? 'selected' : ''}} {{$premio->Estado == "PENDIENTE" ? 'selected' : ''}}>PENDIENTE</option>
                        <option value="COMPLETO" {{"COMPLETO" == old('Estado') ? 'selected' : ''}} {{$premio->Estado == "COMPLETO" ? 'selected' : ''}}>COMPLETO</option>
                    </x-slot>
                    <x-slot name="message">
        ...
        @php
            $premio->load('itemsPremio.usuario');
        @endphp

        @livewire('repartir-premios-edit-form', ['premio' => $premio, 'items_premio' => $premio->itemsPremio])
