<x-layout>
  ...
  <x-slot name="breadcrumbs">
      <li class="nav-home">
        ...
        <li class="separator"><i class="icon-arrow-right"></i></li>
        <li class="nav-item"><a href="#">Editar materiales</a></li>
  </x-slot>

    <x-form>
        <x-slot name="card_title">Editar material</x-slot>
        <x-slot name="action">{{ route('materiales.update', $material) }}</x-slot>
        ...
        <x-slot name="inputs">
            ...
            <div class="col-md-6 mb-3">
                <x-form-input-default>
                    ...
                    <x-slot name="value">{{old('Nombre', $material->Nombre)}}</x-slot>
                    <x-slot name="message">
                ...
                <x-form-input-checkbox>
                    ...
                    <x-slot name="checked">{{ $material->Predeterminado == 1 ? 'checked' : '' }}</x-slot>
                </x-form-input-checkbox>
            </div>
            ...
            <div class="col-md-6 mb-3">
                <x-form-input-default>
                    ...
                    <x-slot name="placeholder"></x-slot>
                    <x-slot name="value">{{old('Descripcion', $material->Descripcion)}}</x-slot>
                    <x-slot name="message">
