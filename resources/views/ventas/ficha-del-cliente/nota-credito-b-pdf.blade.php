    ...
    <body>
                    ...
                    <table style="width: 100%; font-size:10px;">
                        <tr>
                            ...
                            <td style="width: 45%; text-align: left;">
                                {{ \Carbon\Carbon::parse($nota_credito->FechaEmision)->format('d/m/Y') }}
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left;">Vencimiento:</td>
                            <td style="text-align: left;">
                                {{ \Carbon\Carbon::parse($nota_credito->FechaVencimiento)->format('d/m/Y') }}
                            </td>
                        </tr>
                    </table>
        ...
        <table class="cliente-info">
            <tr>
                ...
                <td>{{ $nota_credito->RazonSocial }}</td>
            </tr>
            <tr>
                <td class="label">Dirección:</td>
                <td>{{ $nota_credito->Direccion }}, {{ $nota_credito->Localidad }}</td>
            </tr>
            <tr>
                <td class="label">Categoría IVA:</td>
                <td>{{ $nota_credito->condicionIVA->Nombre ?? "N/A" }}</td>
            </tr>
            <tr>
                <td class="label">DNI:</td>
                <td>
                    {{ $nota_credito->NumeroDocumentoCliente }}

                    <span style="margin-left:100px;">
                        Cbte asco.: {{ $nota_credito->facturaVenta->NumeroCompleto }}
                    </span>
                </td>
            </tr>
        </table>
        ...
        <table class="tabla-detalle">
            ...
            <tbody>
                @foreach($items_nota_credito as $item_nota_credito)
                    ...
                    <tr>
                        <td style="text-align:left;">{{ $item_nota_credito->id }}</td>
        ...
        <div id="footer">
            ...
            <table style="width:100%; margin-top:10px;">
                <tr>
                    ...
                    <td style="width:50%; vertical-align: top;">
                        <table class="totales">
                        <tr><td>Subtotal:</td><td>{{ number_format($nota_credito->Total, 2, ',', '.') }}</td></tr>
