    ...
    <x-simple-table2>
        ...
        <x-slot name="tbody">
            <div class="d-flex justify-content-center py-5">
                ...
                <a target="_blank" rel="noopener noreferrer" onclick="setTimeout(() => location.reload(), 500);" href="{{ route('ventas.ficha-del-cliente-recibo-venta.pdf', $recibo_venta) }}" class="position-relative text-center mx-5" style="cursor: pointer; text-decoration: none; color: inherit;">
            ...
            <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <x-simple-table2>
                        ...
                        <x-slot name="tbody">
                            @forelse ($recibo_venta->cliente->emails as $email)
                                <tr>
                                    <td>
                                    <input type="checkbox"
                                        name="emails[]"
                ...
                <div class="modal-footer justify-content-end">
                    ...
                    onclick="
                            ...
                            this.href = '{{ route('ventas.ficha-del-cliente-recibo-venta.email', $recibo_venta) }}?' + qs.toString();
                    ">
