                    ...
                    <div class="form-group mb-1">
                        ...
                        <select name="PuntoVenta" id="PuntoVenta" class="form-control form-control-sm py-0" disabled>
                            @foreach ($pto_ventas as $pto_venta)
                                <option value="{{ $pto_venta->Numero }}" {{$pto_venta->Numero == $factura_venta->PuntoVenta ? 'selected' : ''}}>
                                    {{ $pto_venta->Nombre }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-2">
                    <div class="form-group mb-1">
                        ...
                        <input type="text" id="Numero"
                            value="{{ $factura_venta->Numero }}"
                            class="form-control form-control-sm py-0" disabled>
                        <input type="hidden" name="Numero" value="{{ $factura_venta->Numero }}">
                    </div>
                </div>
                ...
                <div class="col-2">
                    <div class="form-group mb-1">
                        ...
                        <input type="date" id="FechaEmision" name="FechaEmision" disabled
                            value="{{ $factura_venta->FechaEmision }}"
                ...
                <div class="col-2">
                    ...
                    <div class="input-group mb-1">
                        <input type="date" id="FechaVencimiento" name="FechaVencimiento" disabled
                            value="{{ $factura_venta->FechaVencimiento }}"
                            class="form-control form-control-sm py-0">
            ...
            <div class="row mb-2 align-items-end">
                ...
                <div class="col-2">
                    <div class="form-group mb-1">
                        ...
                        <input value="{{ $factura_venta->IdCliente }}" class="form-control form-control-sm py-0" disabled>
                        <input type="hidden" name="IdCliente" value="{{ $factura_venta->IdCliente }}">
                    </div>
                </div>
                ...
                <div class="col-2">
                    <div class="form-group mb-1">
                        ...
                        <input type="text" id="Numero" name="Numero"
                            value="{{ $factura_venta->RazonSocial }}"
                            class="form-control form-control-sm py-0" disabled>
                    </div>
                </div>
                ...
                <div class="col-4">
                    ...
                    <input 
                        value="{{ $factura_venta->CondicionVenta }}"
                        class="form-control form-control-sm py-0"
                        disabled
                    >
            ...
            <div class="d-flex justify-content-center py-5">
                ...
                <a target="_blank" rel="noopener noreferrer" onclick="setTimeout(() => location.reload(), 500);" href="{{ route(
                    ...
                    <div style="
                        ...
                        text-align: center;
                    ">
                        {{ $factura_venta->CantidadImpresiones }}
                    </div>
                ...
                style="cursor: pointer; text-decoration: none; color: inherit;">
                    ...
                    <div style="
                        ...
                        text-align: center;
                    ">
                        {{ $factura_venta->CantidadEnviosPorCorreo }}
                    </div>
    ...
    <div class="container-fluid px-4 py-3">
        <div class="row">
            <div class="col-12 d-flex justify-content-end">
                ...
                href="{{ route('ventas.ficha-del-cliente.show', $factura_venta->IdCliente) }}">
