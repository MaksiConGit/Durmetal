    ...
    <x-simple-table2>
        ...
        <x-slot name="filtros">
                ...
                <div class="col-2">
                    <div class="form-group mb-1">
                        ...
                        <input type="text" id="Numero"
                            value="{{ $nota_debito->Numero }}"
                            class="form-control form-control-sm py-0" disabled>
                        <input type="hidden" name="Numero" value="{{ $nota_debito->Numero }}">
                    </div>
                </div>
                ...
                <div class="col-2">
                    <div class="form-group mb-1">
                        ...
                        <input type="date" id="FechaEmision" name="FechaEmision" disabled
                            value="{{ $nota_debito->FechaEmision }}"
            ...
            <div class="row mb-2 align-items-end">
                ...
                <div class="col-2">
                    <div class="form-group mb-1">
                        ...
                        <input type="hidden" name="IdCliente" value="{{ $nota_debito->IdCliente }}">
                    </div>
                </div>
            ...
            <div class="row mb-2 align-items-end">
                ...
                <div class="col-10">
                    ...
                    <input 
                        value="{{ $nota_debito->CondicionVenta }}"
                        class="form-control form-control-sm py-0"
                        disabled
                    >
        ...
        <x-slot name="tbody">
            <div class="d-flex justify-content-center py-5">
                ...
                <a target="_blank" rel="noopener noreferrer" onclick="setTimeout(() => location.reload(), 500);" href="{{ route('ventas.ficha-del-cliente-factura-venta.pdf', $nota_debito) }}" class="position-relative text-center mx-5" style="cursor: pointer; text-decoration: none; color: inherit;">
                    ...
                    <div style="
                        ...
                        text-align: center;
                    ">
                        {{ $nota_debito->CantidadImpresiones }}
                    </div>
                ...
                <div class="position-relative text-center mx-5" style="cursor: pointer;" onclick="alert('Enviar por correo')">
                    ...
                    <div style="
                        ...
                        text-align: center;
                    ">
                        {{ $nota_debito->CantidadEnviosPorCorreo }}
                    </div>
