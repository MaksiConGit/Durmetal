    ...
    <x-simple-table2>
                ...
                <div class="col-2">
                    <div class="form-group mb-1">
                        ...
                        <input type="text" id="Numero"
                            value="{{ $nota_envio->Numero }}"
                            class="form-control form-control-sm py-0" disabled>
                        <input type="hidden" name="Numero" value="{{ $nota_envio->Numero }}">
                    </div>
                </div>
        ...
        <x-slot name="tbody">
            <div class="d-flex justify-content-center py-5">
                ...
                <a target="_blank" rel="noopener noreferrer" onclick="setTimeout(() => location.reload(), 500);" href="{{ route('ventas.ficha-del-cliente-nota-envio.pdf', $nota_envio) }}" class="position-relative text-center mx-5" style="cursor: pointer; text-decoration: none; color: inherit;">
                    ...
                    <div style="
                        ...
                        text-align: center;
                    ">
                        {{ $nota_envio->CantidadImpresiones }}
                    </div>
                ...
                style="cursor: pointer; text-decoration: none; color: inherit;">
                    ...
                    <div style="
                        ...
                        text-align: center;
                    ">
                        {{ $nota_envio->CantidadEnviosPorCorreo }}
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <x-simple-table2>
                        ...
                        <x-slot name="tbody">
                            @forelse ($nota_envio->cliente->emails as $email)
                                <tr>
                                    <td>
                                    <input type="checkbox"
                                        name="emails[]"
    ...
    <div class="container-fluid px-4 py-3">
        <div class="row">
            <div class="col-12 d-flex justify-content-end">
                <a class="btn btn-sm btn-primary" href="{{ route('ventas.ficha-del-cliente.show', $nota_envio->IdCliente) }}">
