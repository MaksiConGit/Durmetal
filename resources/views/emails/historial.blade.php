...
<head>
    <meta charset="UTF-8">
    <title>HISTORIAL DE TRABAJOS EN OT 0001-00064264</title>
</head>
<body style="
                ...
                <tr>
                    <td style="padding: 10px 0;">
                        ...
                        <p style="margin: 0 0 15px 0;">
                            Enviamos el <strong>Historial de trabajos de la {{ $orden_trabajo->NumeroCompleto }}</strong> en el archivo adjunto. 
                        </p>
