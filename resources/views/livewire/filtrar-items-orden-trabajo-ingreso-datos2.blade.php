                                        ...
                                        <div style="margin-right:12px;" >
                                            <button
                                                ...
                                                style="
                                                    width:52px;
                                                    height:26px;
                                                    background-color: {{ $item->CantidadCertificadosImpresos > 0 ? '#28a745' : '#f28c00' }};
                                                    color:white;
                                                    border:none;
                                                    border-radius:3px;
                                                "
                                            >
                                                @if ($item->CantidadCertificadosImpresos > 0)
                                        ...
                                        <div>
                                            <button
                                                ...
                                                style="
                                                    width:52px;
                                                    height:26px;
                                                    background-color: {{ $item->CantidadCertificadosEnviadosPorCorreo > 0 ? '#28a745' : '#f28c00' }};
                                                    color:white;
                                                    border:none;
                                                    border-radius:3px;
                                                "
                                            >
                                                @if ($item->CantidadCertificadosEnviadosPorCorreo > 0)
                                                    <span style="margin-right:6px;">
