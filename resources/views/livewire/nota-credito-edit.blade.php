...
<div>
    <x-layout2-sidebar>
        ...
        <form action="{{ route('ventas.ficha-del-cliente-nota-credito.update', $nota_credito)}}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="row mb-2 align-items-end">
                        ...
                        <div class="col-2">
                            <div class="form-group mb-1">
                                ...
                                <input value="{{ $nota_credito->IdCliente }}" class="form-control form-control-sm py-0" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            <div class="form-group mb-1">
                                ...
                                <input type="text" id="Numero" name="Numero"
                                    value="{{ $nota_credito->RazonSocial }}"
                                    class="form-control form-control-sm py-0" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <div class="input-group mb-1">
                                ...
                                <input 
                                    value="{{ $nota_credito->facturaVenta->NumeroCompleto }}"
                                    class="form-control form-control-sm py-0"
                                    disabled
                                >
                            </div>
...
{{-- 
                    ...
                    @foreach ($nota_credito->itemsNotaCredito as $items_nota_credito)
                        <tr>
                            <td>{{ $items_nota_credito->IdArticulo }}</td>
                            <td>{{ $items_nota_credito->Descripcion }}</td>
                            <td>{{ number_format($items_nota_credito->Cantidad, 2, ',', '.') }}</td>
                            <td>{{ number_format($items_nota_credito->PrecioUnitario, 2, ',', '.') }}</td>
                            <td>{{ number_format($items_nota_credito->AlicuotaIVA, 2, ',', '.') }}</td>
                            <td>{{ number_format($items_nota_credito->Neto, 2, ',', '.') }}</td>
                        </tr>
                    @endforeach
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-5 w-100">
                            ...
                            >{{ $nota_credito->Observaciones }}</textarea>
                        </div>

                        <div class="mb-3 d-flex align-items-center">
                            <label class="form-label fw-normal small me-2 mb-0 mr-3">ESTADO</label>
                            <input type="text" class="form-control form-control-sm text-dark w-auto" value="{{ $nota_credito->Estado }}" disabled>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="d-flex flex-column align-items-end fs-6">
                            ...
                            <div class="w-100 mb-1 d-flex justify-content-between">
                                ...
                                <input 
                                    type="text"
                                    readonly
                                    value="{{ number_format($nota_credito->Neto, 2, ',', '.') }}"
                            ...
                            <div class="w-100 mb-2 d-flex justify-content-between">
                                ...
                                <input 
                                    type="text"
                                    readonly
                                    value="{{ number_format($nota_credito->IVA, 2, ',', '.') }}"
                            ...
                            <div class="w-100 mb-2 d-flex justify-content-between align-items-center">
                                ...
                                <input 
                                    type="text"
                                    disabled
                                    value="{{ number_format($nota_credito->Total, 2, ',', '.') }}"
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            ...
                            <a class="btn btn-app bg-primary" href="{{ route('ventas.ficha-del-cliente-nota-credito.show', $nota_credito) }}">
                            ...
                            <a class="btn btn-app bg-primary" href="{{ route('ventas.ficha-del-cliente.show', $nota_credito->cliente) }}">
