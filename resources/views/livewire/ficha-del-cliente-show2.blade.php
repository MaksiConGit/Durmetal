                ...
                <div class="form-group mb-3">
                    ...
                    @switch($activeTabParametros)
                        ...
                        @case('custom-tabs-3')
                            <a 
                                @if ($selectedId)
                                    class="btn btn-app bg-primary" href="{{ route('ventas.ficha-del-cliente-factura-venta.edit', $selectedId) }}"
                                @else
                                    class="btn btn-app bg-primary disabled" 
                                @endif
                            >
                        ...
                        @case('custom-tabs-4')
                            <a 
                                @if ($selectedId)
                                    class="btn btn-app bg-primary" href="{{ route('ventas.ficha-del-cliente-recibo-venta.edit', $selectedId) }}"
                                @else
                                    class="btn btn-app bg-primary disabled" 
                                @endif
                            >
                        ...
                        @case('custom-tabs-5')
                            <a 
                                @if ($selectedId)
                                    class="btn btn-app bg-primary" href="{{ route('ventas.ficha-del-cliente-nota-credito.edit', $selectedId) }}"
                                @else
                                    class="btn btn-app bg-primary disabled" 
                                @endif
                            >
                        ...
                        @case('custom-tabs-6')
                            <a 
                                @if ($selectedId)
                                    class="btn btn-app bg-primary" href="{{ route('ventas.ficha-del-cliente-nota-debito.edit', $selectedId) }}"
                                @else
                                    class="btn btn-app bg-primary disabled" 
                                @endif
                            >
