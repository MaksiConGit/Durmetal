...
<div>
    <style>
        ...
        #modal-cliente .tabla-clientes-scroll {
            height: 100% !important;
            overflow-x: auto !important;
            overflow-y: auto !important;
        }

        #modal-cliente .tabla-clientes-scroll table {
            font-size: 15px !important;
            margin-bottom: 0 !important;
        }

        #modal-cliente .tabla-clientes-scroll table thead th {
        ...
        #modal-cliente .tabla-clientes-scroll table tbody td {
        ...
        #modal-cliente .tabla-clientes-scroll table tbody tr {
            height: 24px !important;
        }
    </style>
    <x-simple-table2>
                        ...
                        <x-simple-table2>
                            ...
                            <x-slot name="tbody">
                                ...
                                @php
                                    ...
                                    $filasFaltantes = max(0, $minFilas - $clientesActuales);
                                @endphp
