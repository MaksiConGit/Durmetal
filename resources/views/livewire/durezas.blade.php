            ...
            <div class="form-inline mt-5 mr-3 d-flex flex-column align-items-center">
                ...
                <div class="form-group mb-3">
                    <button
                        ...
                        onclick="return confirm('¿Estás seguro que deseas eliminar esta dureza?')"
                    >
            ...
            <x-slot name="tbody">
                @forelse ($durezas as $dureza)
                    <tr 
                        ...
                        wire:click="selectItem({{ $dureza->id }})"
                        class="{{ $selectedItem == $dureza->id ? 'table-primary' : '' }}"
                    >
                        <td>{{ $dureza->Nombre }}</td>
                        <td>{{ $dureza->Descripcion }}</td>
                        <td class="text-center">
                            <input type="checkbox" disabled {{ $dureza->Predeterminado ? 'checked' : '' }}>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="3" class="text-center">No hay durezas registradas</td>
                    </tr>
                @endforelse
            </x-slot>
        </x-simple-table2>
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6">
                        <div class="form-check">
                            <input id="Predeterminado" type="checkbox" name="Predeterminado" value="1" {{ old('Predeterminado', $selectedDureza->Predeterminado) == 1 ? 'checked' : '' }} class="form-check-input
