        ...
        <x-simple-table2>
            <x-slot name="filtros">
                <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="customRadio2" name="customRadio" wire:model.live="filtroTipo" value="NotaEnvio">
                        <label for="customRadio2" class="custom-control-label font-weight-normal">Nota de Envío</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="customRadio3" name="customRadio" wire:model.live="filtroTipo" value="FacturaVenta">
                        <label for="customRadio3" class="custom-control-label font-weight-normal">Factura</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="customRadio4" name="customRadio" wire:model.live="filtroTipo" value="NotaDebito">
                        <label for="customRadio4" class="custom-control-label font-weight-normal">Nota de Débito</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="customRadio5" name="customRadio" wire:model.live="filtroTipo" value="NotaCreditoVenta">
                        <label for="customRadio5" class="custom-control-label font-weight-normal">Nota de Crédito</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="customRadio6" name="customRadio" wire:model.live="filtroTipo" value="ReciboVenta">
