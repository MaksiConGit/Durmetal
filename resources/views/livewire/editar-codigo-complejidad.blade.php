<div class="row">
    <input type="hidden" name="IdTratamiento" value="{{ $this->tratamiento->id }}">
    ...
    <div class="col-md-2 mb-3">
        <x-form-input-select>
            ...
            <x-slot name="option">
                ...
                <option value="ARS" {{"ARS" == old('Divisa', $this->divisa) ? 'selected' : ''}}>ARS</option>
                <option value="USD" {{"USD" == old('Divisa', $this->divisa) ? 'selected' : ''}}>USD</option>
            </x-slot>
            <x-slot name="message">
    ...
    <div class="col-md-12 mb-3">
        <x-form-input-default>
            ...
            <x-slot name="placeholder"></x-slot>
            <x-slot name="value">{{old('Descripcion', $this->descripcion)}}</x-slot>
            <x-slot name="message">
