<x-layout>
    ...
    <x-slot name="breadcrumbs">
        ...
        <li class="separator"><i class="icon-arrow-right"></i></li>
        <li class="nav-item"><a href="#">Añadir Cuenta de Gastos</a></li>
    </x-slot>

    <x-form>
        <x-slot name="title">Durmetal</x-slot>
        <x-slot name="card_title">Crear Cuenta de Gastos</x-slot>
        <x-slot name="action">{{ route('compras.actualizaciones.cuentas-de-gastos.store') }}</x-slot>
