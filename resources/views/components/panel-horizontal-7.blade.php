<div class="card">
    ...
    <div class="card-body">
        <ul class="nav nav-pills nav-primary" id="pills-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="pills-tab6" data-bs-toggle="pill" href="#pills-pane6" role="tab" aria-controls="pills-pane6" aria-selected="false">{{ $panel6 }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-tab7" data-bs-toggle="pill" href="#pills-pane7" role="tab" aria-controls="pills-pane7" aria-selected="false">{{ $panel7 }}</a>
            </li>
        </ul>
        <div class="tab-content mt-2 mb-3" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-pane6" role="tabpanel" aria-labelledby="pills-tab6">
                {{ $body6 }}
            </div>
            <div class="tab-pane fade" id="pills-pane7" role="tabpanel" aria-labelledby="pills-tab7">
                {{ $body7 }}
            </div>
        </div>
    </div>
