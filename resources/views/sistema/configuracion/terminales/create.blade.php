<x-layout>
    ...
    <x-form>
        ...
        <x-slot name="action">{{ route('sistema.configuracion.terminales.store') }}</x-slot>
        ...
        <x-slot name="inputs">
            ...
            <div class="col-md-8 mb-3">
                ...
                <x-form-input-default>
                    ...
                    <x-slot name="value">{{old('NombreHost')}}</x-slot>
                    <x-slot name="message">
                        @error('NombreHost')
                            {{$message}}
                        @enderror
            ...
            <div class="col-md-8 mb-3">
                <x-form-input-select>
                    ...
                    @foreach ($impresoras_fiscales as $impresora_fiscal)
                        <option value="{{$impresora_fiscal->id}}">{{$impresora_fiscal->Nombre}}</option>                            
                    @endforeach
                    </x-slot>
                    <x-slot name="message">
            ...
            <div class="col-md-8 mb-3">
                <x-form-input-select>
                    ...
                    <x-slot name="option">
                        <option value="-1">No hay etiquetadora asociada</option>
