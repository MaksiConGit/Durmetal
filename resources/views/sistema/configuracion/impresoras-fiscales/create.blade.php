<x-layout>
    ...
    <x-slot name="breadcrumbs">
        <li class="nav-home">
            ...
            <li class="separator"><i class="icon-arrow-right"></i></li>
            <li class="nav-item"><a href="#">Añadir Impresora Fiscal</a></li>
    </x-slot>

    <x-form>
        <x-slot name="title">Durmetal</x-slot>
        <x-slot name="card_title">Añadir Impresora Fiscal</x-slot>
        <x-slot name="action">{{ route('sistema.configuracion.impresoras-fiscales.store') }}</x-slot>
        ...
        <x-slot name="inputs">
            ...
            <div class="col-md-8 mb-3">
                ...
                <x-form-input-default>
                    ...
                    <x-slot name="placeholder"></x-slot>
                    <x-slot name="value">{{old('Modelo')}}</x-slot>
                    <x-slot name="message">
                        @error('Modelo')
                            {{$message}}
                        @enderror
            ...
            <div class="col-md-8 mb-3">
                ...
                <x-form-input-default>
                    ...
                    <x-slot name="placeholder"></x-slot>
                    <x-slot name="value">{{old('PuertoCOM', 0)}}</x-slot>
                    <x-slot name="message">
                        @error('PuertoCOM')
                            {{$message}}
                        @enderror
            ...
            <div class="col-md-8 mb-3">
                ...
                <x-form-input-default>
                    ...
                    <x-slot name="placeholder"></x-slot>
                    <x-slot name="value">{{old('VelocidadPrEpson', 3)}}</x-slot>
                    <x-slot name="message">
            ...
            <div class="col-md-8 mb-3">
                ...
                <x-form-input-default>
                    ...
                    <x-slot name="placeholder"></x-slot>
                    <x-slot name="value">{{old('TipoProtocoloPrEpson', 0)}}</x-slot>
                    <x-slot name="message">
