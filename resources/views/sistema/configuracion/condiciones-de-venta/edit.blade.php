<x-layout>
    ...
    <x-slot name="breadcrumbs">
        <li class="nav-home">
            ...
            <li class="separator"><i class="icon-arrow-right"></i></li>
            <li class="nav-item"><a href="#">Editar Condición de Venta</a></li>
    </x-slot>

    <x-form>
        <x-slot name="title">Durmetal</x-slot>
        <x-slot name="card_title">Editar Condición de Venta</x-slot>
        <x-slot name="action">{{ route('sistema.configuracion.condiciones-de-venta.update', $condicion_venta) }}</x-slot>
        ...
        <x-slot name="inputs">
            ...
            <div class="col-md-8 mb-3">
                ...
                <x-form-input-default>
                    ...
                    <x-slot name="value">{{old('Nombre', $condicion_venta->Nombre)}}</x-slot>
                    <x-slot name="message">
                        @error('Nombre')
                            {{$message}}
                        @enderror
                ...
                <x-form-input-checkbox>
                    ...
                    <x-slot name="checked">
                        {{ old('Seleccionado', $condicion_venta->Seleccionado) == 1 ? 'checked' : '' }}
                    </x-slot>
                </x-form-input-checkbox>
