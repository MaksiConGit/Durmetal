...
use App\Exports\ReportesPesosResumidoExport;
use Maatwebsite\Excel\Facades\Excel;

class ReportesPesosResumido extends Component
{
    public $selectedIds = [];
    ...
    public function exportarExcel()
    {
        return Excel::download(
            new ReportesPesosResumidoExport(
                $this->getItemsFiltrados()->get()
            ),
            'reporte-pesos-resumido.xlsx'
        );
    }
    ...
    public function render()
    {
        ...
        return view('livewire.reportes-pesos-resumido', [
