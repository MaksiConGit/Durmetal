...
class NotaDebitoEdit extends Component
{
    public $notas_envio;
    ...
    if ($this->nota_debito && $this->nota_debito->CondicionVenta) {
        $this->condicionesSeleccionadas = array_map(
            'trim',
            explode(' / ', $this->nota_debito->CondicionVenta)
        );
    } else {
    ...
    {
        return view('livewire.nota-debito-edit');
    }
}
