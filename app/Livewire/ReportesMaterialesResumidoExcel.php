...
use App\Exports\ReportesMaterialesResumidoExcelExport;
use Maatwebsite\Excel\Facades\Excel;

class ReportesMaterialesResumidoExcel extends Component
{
    public $selectedIds = [];
    ...
    public function exportarExcel()
    {
        return Excel::download(
            new ReportesMaterialesResumidoExcelExport(
                $this->getItemsFiltrados()->get()
            ),
            'reporte-materiales-resumido-excel.xlsx'
        );
    }
    ...
    public function render()
    {
        ...
        return view('livewire.reportes-materiales-resumido-excel', [
