...
class StoreFacturacompraRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'EsNotaDeDebito' => 'required|boolean',
            'NroFacturaNotaDebito' => 'nullable|integer',
            ...
            'LetraPuntoVentaNumeroIdProveedor' => 'required|string',
        ];
    }
}
