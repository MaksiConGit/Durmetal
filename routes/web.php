...
Route::middleware('auth')->group(function () {
    ...
    Route::get('ingreso-datos/pdf-sin-certificado/{item}', [IngresoDatosController::class, 'pdfSinCertificado'])->name('ingreso-datos.pdf-sin-certificado');
    Route::get(
        '/ingreso-datos/{certificado}/email',
        [IngresoDatosController::class, 'email']
    )->name('ingreso-datos.email');
    Route::get(
        '/ingreso-datos/{item}/email-sin-certificado',
        [IngresoDatosController::class, 'emailSinCertificado']
    )->name('ingreso-datos.email-sin-certificado');
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        Route::get('ficha-del-cliente/nota-debito/pdf/a/{nota_debito}', [VentasController::class, 'fichaDelClienteNotaDebitoAPDF'])->name('ventas.ficha-del-cliente-nota-debito-a.pdf');
        Route::get('ficha-del-cliente/nota-debito/pdf/b/{nota_debito}', [VentasController::class, 'fichaDelClienteNotaDebitoBPDF'])->name('ventas.ficha-del-cliente-nota-debito-b.pdf');
        ...
        Route::get('compras/resumen-cuenta-corriente', [ComprasController::class, 'resumenCuentaCorriente'])->name('compras.resumen-cuenta-corriente');
